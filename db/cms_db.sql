...
-- -----------------------------------------------------
-- Table `cms_db`.`change_order_variables`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cms_db`.`change_order_variables` ;

CREATE TABLE IF NOT EXISTS `cms_db`.`change_order_variables` (
  `disint_fee_1` DECIMAL(9,2) UNSIGNED NOT NULL,
  `disint_fee_2` DECIMAL(9,2) UNSIGNED NOT NULL,
  `disint_fee_3` DECIMAL(9,2) UNSIGNED NOT NULL,
  `disint_fee_4` DECIMAL(9,2) UNSIGNED NOT NULL,
  `admin_fee_2` DECIMAL(9,2) UNSIGNED NOT NULL,
  `transfer_fee` DECIMAL(9,2) UNSIGNED NOT NULL,
  `admin_fee_percentage` DECIMAL(2,2) UNSIGNED NOT NULL)
ENGINE = InnoDB;
...
GRANT SELECT, UPDATE ON TABLE `cms_db`.`change_order_variables` TO 'cms_app';
SET SQL_MODE = '';
GRANT USAGE ON *.* TO cms_user;
 DROP USER cms_user;
SET SQL_MODE='TRADITIONAL,ALLOW_INVALID_DATES';
CREATE USER 'cms_user' IDENTIFIED BY '546dTw2YhmIw';

GRANT SELECT, UPDATE, DELETE ON TABLE `cms_db`.`change_order` TO 'cms_user';
GRANT SELECT, UPDATE ON TABLE `cms_db`.`change_order_variables` TO 'cms_user';
GRANT SELECT, UPDATE, INSERT ON TABLE `cms_db`.`employee` TO 'cms_user';
GRANT SELECT, UPDATE, DELETE ON TABLE `cms_db`.`patron` TO 'cms_user';
...
-- -----------------------------------------------------
-- Data for table `cms_db`.`change_order_variables`
-- -----------------------------------------------------
START TRANSACTION;
USE `cms_db`;
INSERT INTO `cms_db`.`change_order_variables` (`disint_fee_1`, `disint_fee_2`, `disint_fee_3`, `disint_fee_4`, `admin_fee_2`, `transfer_fee`, `admin_fee_percentage`) VALUES (1950.00, 1350.00, 750.00, 500.00, 100.00, 300.00, 0.20);
