...
CREATE TABLE IF NOT EXISTS `cms_db`.`change_order_variables` (
  `disint_fee_1` DECIMAL(9,2) NOT NULL,
  `disint_fee_2` DECIMAL(9,2) NOT NULL,
  `disint_fee_3` DECIMAL(9,2) NOT NULL,
  `disint_fee_4` DECIMAL(9,2) NOT NULL,
  `admin_fee_2` DECIMAL(9,2) NOT NULL,
  `transfer_fee` DECIMAL(9,2) NOT NULL,
